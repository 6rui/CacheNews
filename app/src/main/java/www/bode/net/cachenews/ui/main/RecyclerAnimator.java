...
public class RecyclerAnimator extends SimpleItemAnimator {
    ...
    private static class MoveInfo {
        ...
        private MoveInfo(ViewHolder holder,
                         int fromX,
                         int fromY,
                         int toX,
                         int toY) {
    ...
    private static class ChangeInfo {
        ...
        private ChangeInfo(ViewHolder oldHolder,
    ...
    public void runPendingAnimations() {
        ...
        if (changesPending) {
            ...
            if (removalsPending) {
                ...
                ViewCompat.postOnAnimationDelayed(holder.itemView,
                                                  changer,
                                                  getRemoveDuration());
            }
            else {
    ...
    public boolean animateChange(ViewHolder oldHolder,
        ...
        mPendingChanges.add(new ChangeInfo(oldHolder,
                                           newHolder,
                                           fromX,
                                           fromY,
                                           toX,
        ...
        if (newView != null) {
            ...
            newViewAnimation.translationX(0)
                            ...
                            .setListener(new VpaListenerAdapter() {
                                @Override
                                public void onAnimationStart(View view) {
                                    dispatchChangeStarting(changeInfo.newHolder,
                                                           false);
                                }
     ...
     * <ul>
     * <li>If you override
     * {@link #animateChange(ViewHolder, ViewHolder, int, int, int, int)}, both
     * ViewHolder arguments will be the same instance.</li>
     * <li>If you are not overriding
     * {@link #animateChange(ViewHolder, ViewHolder, int, int, int, int)}, then
     * DefaultItemAnimator will call
     * {@link #animateMove(ViewHolder, int, int, int, int)} and run a move
     * animation instead.</li>
     * </ul>
     */
    @Override
    ...
    private static class VpaListenerAdapter implements
